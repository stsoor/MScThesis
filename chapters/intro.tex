...
\IF{$v.lowlink = v.number$}
	...
	\UNTIL{$w.number \geq v.number$} \COMMENT{a stack mindig tartalmazza $v$-t}
\ENDIF
...
% TODO síkbarajzolhatóság = felesleges metszetek elkerülése
