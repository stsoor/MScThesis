...
Összefoglaló néven sztochasztikus algoritmus névvel illetjük azokat a módszereket, amelyek futásuk során valószínűségi változókat alkalmaznak. A gradiens leszállás során látott véletlen kezdőpont kiválasztása nem része az iterációnak, így annak alapverziója nem számít sztochasztikus algoritmusnak.

% TODO GA, PSO, Hill climbing, simulated annealing
% 3 oldal, GA + alg, PSO + alg, SGD+alg, általános + a többi
