...
\begin{compactenum}
	...
	\item A szimmetrikusan normalizált Laplaciant az $L = (I-\sqrt(inv(D))*A_x*\sqrt(inv(D)))$ képlet adja, azonban a konvulúciós réteg alkalmazása során $A_X$ helyett az $\tilde A = A_X + I$ mátrixot használjuk.
\end{compactenum}

%TODO FastHGCN impl, laplacian fix, line graph HGNN impl
...
\subsection{Euler-diagram reprezentáció} % 5
