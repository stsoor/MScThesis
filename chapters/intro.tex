...
%\begin{note}
%Bár a genetikus algorimus hagyományosan maximalizálási feladatként van megfogalmazva, én - a többi algoritmussal való kompatibilitás érdekében - minimalizációra használtam. Ahogy korábban láttuk, bármelyik visszavezethető a másikra.
%\end{note}

A születést/halált modellező szelekciós függvényt és a szülők kiválasztását (melyek az erdeti leírásban együttesen $selectFitnessProportionally$ néven, $population,fitnessValues,parentNumber$ paraméterekkel szerepeltek) két lépésre bontottam. A szelekció azonosan is működik minden esetben, azonban a szülők kiválasztása nem.
