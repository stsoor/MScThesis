...
Az egyes algoritmusok megoldáspopulációjának méretét érdemes az iterációk számával nagyságrendileg arányosnak beállítani. PSO esetén fontos a $c_1$ paraméter magasra állításának kerülése, míg GA esetén ugyenez mondható el a $selectionRate$ és $mutationRate$ hiperparaméterekről.


Szemantikailag jól teljesítettek a kidolgozott heurisztikák, kisebb hipergráfokon biztosítják az elvárt tulajdonságokat. A szegmensmetszeteket leszorító mérőszám alternatívájaként állított módszer nem csak gyorsabb, de hamis pozitív tartalmazások számát is hatékonyabban minimalizálja, ezért érdemes lehet akkor is megtartani, ha a metszetek számát direkt módon is szeretnénk csökkenteni.
