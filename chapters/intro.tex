...
\begin{longtable}{| p{0.25\textwidth} | p{0.2\textwidth} | p{0.35\textwidth} |}
		\hline
		\textbf{Inicializáció} & \textbf{Algoritmus} & \textbf{Algoritmus paraméterek} \\
		\hline \hline
		Egyenletes eloszlás & PSO & $w=c_1=c_2=0.5$, $S=200$\\
		\hline
