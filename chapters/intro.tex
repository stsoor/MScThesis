...
A particle swarm optimization (PSO) egy másik biológiailag inspirált algoritmus, amely analóg módon működik egyes rajként együtt dolgozó állat- és rovarfajokkal\cite{non_gradient_optimization, pso, modified_pso}. A módszer alapelve, hogy különböző, részecskéknek nevezett, entitások pozícióiban értékeljük ki az $f$ költségfüggvényt. A részecskék haladási sebességgel rendelkeznek, amelyet minden iterációban úgy frissítünk, hogy figyelembe vesszük a részecske által, illetve a globálisan talált legjobb pozíciót/értéket.
...
Számos további megszorítás és függvényosztály létezik, amelyre létezik hozzászabott optimalizációs algoritmus, mint például lineáris egyenlőtlenségrendszerek vagy diszkrét halmazok esetén, azonban ezekre itt nem térünk ki.

% TODO ma

\subsection{Függvényapproximáció}
\subsubsection{Lineáris függvényapproximáció}
\subsubsection{Nem-lineáris függvényapproximáció}
