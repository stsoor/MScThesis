...
\begin{table}[H]
	...
	\begin{tabular}{ | m{0.25\textwidth} | m{0.65\textwidth} | }
		...
		\hline \hline %\hline
		\emph{Hamis pozitív tartalmazás} & Amennyiben egy $v$ hipercsúcsnak megfelelő pont\\
		\hline
		\emph{Hamis negatív tartalmazás} &  Quisque lobortis eros vitae urna lacinia euismod. \\
		\hline
	\end{tabular}
